...
<body style="text-align:left">
	...
	<div id="content">
		...
		<div style="padding:10px">
			...
			?>
			<table id="draftgrid" class="easyui-datagrid" style="width:auto;height:auto"
					title="Draft" 
					url="php/getdraft.php"
					...
					data-options="
								...
								onClickRow: function(index,row){ 
																 ...
																 addTab('Draft: '+row.id_transaction, row.url);
																 $('#draftgrid').datagrid('clearSelections');
																}
								"> 						
				<thead>
					<tr>
						...
						<th field="revision"       hidden="true"></th>
					</tr>
				</thead>
			</table>
			<br/>
			<a href="#" class="easyui-linkbutton" onclick="movetoTrash();" data-options="plain:false,iconCls:'icon-trash'">Move to trash</a> 
				<script type="text/javascript">  
					function movetoTrash(){  
						var ids = [];  
						var submit = false;
						//var rows = $('#draftgrid').datagrid('getSelections');  
						...
						if(submit){
							$.post("php/deletemessage.php?mode=trash", {IDS:ids.join(',')})
								.done(function(data) {
								if(data!='0'){
